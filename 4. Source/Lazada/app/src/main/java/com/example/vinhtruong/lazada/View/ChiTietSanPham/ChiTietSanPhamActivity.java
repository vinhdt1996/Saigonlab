...
import com.example.vinhtruong.lazada.Model.ObjectClass.ChiTietSanPham;
...
import com.example.vinhtruong.lazada.View.DanhGia.DanhSachDanhGiaActivity;
import com.example.vinhtruong.lazada.View.DanhGia.ThemDanhGiaActivity;
...
public class ChiTietSanPhamActivity extends AppCompatActivity implements ViewChiTietSanPham, ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    TextView txtTenSanPham,txtGiaTien,txtThongTinChiTiet,txtXemTatCaNhanXet,txtGioHang,txtGiamGia;
    Toolbar toolbar;
    ...
    public void HienThiDanhGia(List<DanhGia> danhGiaList) {
        ...
        for(int i=0;i<danhGiaList.size();i++){
            ...
            tongSao+=danhGia.getSOSAO();
        }
        soSao=tongSao/danhGiaList.size();
